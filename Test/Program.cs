...
namespace Test
{
    ...
    {
        private Dictionary<SubrecordType, Action<SubrecordData>> SubrecordDataProc = new Dictionary<SubrecordType, Action<SubrecordData>>();
        ...
        public ProcessingCode ProcessServiceDataSubrecord(ServiceDataSubrecord subrecord)
        {
            ...
            SubrecordDataProc.TryGetValue(subrecord.Type, out Action<SubrecordData> proc);
            proc?.Invoke(subrecord.Data);
        ...
        private void ProcessPosDataSubrecord(SubrecordData subrecordData)
        {
